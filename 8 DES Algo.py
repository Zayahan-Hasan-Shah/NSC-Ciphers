...
def Code():
    ...
    def encryption(user_input):
        ...
        L2.config(text=f"Final Cipher text: {final_cipher_ascii} {len(final_cipher_ascii)}")
...
##        print("Final Cipher text:", final_cipher_ascii , len(final_cipher_ascii))
    ...
    def Decode():
        ...
        final_cipher_ascii = binary_to_ascii(final_cipher_str)
        L2.config(text=f"Decryption of Cipher :{final_cipher_ascii}")
